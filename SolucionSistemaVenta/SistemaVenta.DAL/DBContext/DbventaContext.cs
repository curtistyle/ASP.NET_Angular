...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CCF743B02");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F1A92B70E");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48393FFD381");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1076076E93B");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E612EC0A5");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132006B3979");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76EA30FA18");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8E2EDB94F");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEF82B9799");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E06E5107");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56149CE888AB");
